...
def inference(model, target_test_loader):
    ...
    save_predictions_to_excel(target_pred, target_gt, "/mnt/beegfs/home/liu15/la-ood-tl-main/DeepCORAL/DeepCORAL_xlxs/target_lacticacid_predictions.xlsx")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='PyTorch Deep Coral experiment')
    ...
    weight_path = '/mnt/beegfs/home/liu15/la-ood-tl-main/DeepCORAL/runs_lacticacid/coral_resnet101/resnet101.pth'
    model.load_state_dict(torch.load(weight_path))

    target_whole_loader = data_loader.target_lacticacid_whole_loader
